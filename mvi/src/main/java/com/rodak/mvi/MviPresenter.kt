...
abstract class MviPresenter<S : MviViewState, V : MviView<S, *>, A : MviAction<S>> :
    ViewModel() {
    ...
    protected abstract fun <I : MviIntent> intentToAction(intent: I): Observable<A>
    ...
    protected open fun <I : MviIntent> intentWithoutAction(intent: I) {}
